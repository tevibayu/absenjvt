...
(function() {
    ...
    var presets = [
        
        {
            ...
            freqs: [134,406,926,686],
            types: ["highpass","notch","notch","peaking"],
            Qs: [1,0.5,0.8,1],
            gains: [2,16,1,20]
        },
        {
    ...
    function getLevel() {
        ...
        document.getElementById("avglevel").innerHTML = measures.level > 0 ? measures.averageLevel : 0;
        document.getElementById("deviation").innerHTML = measures.level > 0 ? measures.deviation : 0;
        document.getElementById("avgdev").innerHTML = measures.level > 0 ? measures.averageDeviation : 0;
        document.getElementById("devperlev").innerHTML = measures.level > 0 ? (measures.averageDeviation/measures.averageLevel) : 0;
    ...
    function onGainChanged(e) {
        ...
        document.getElementById("inp_gain").value = e.target.value;
    }
    ...
    function init() {
        ...
        document.getElementById("inp_gain").addEventListener("mousemove", onGainChanged);
